...
token = 'ODYxMTU5NTcxOTU0MjA0Njgy.YOFvWQ.e-dGYVsj_Kji3z_JJVwGxVCjDiQ'
gaming = 'Made By CHOCOBAR'
channel = '861178387557122068'
...
async def on_message(message):
    if message.content.startswith("!인증"):    #명령어 !인증
        ...
        if msg.content == a:
            role = discord.utils.get(message.guild.roles, name="Jaden blue Fan")
